...
void setup(){
  ...
  ClickUpgrade clickUpgrade1 = new ClickUpgrade(new Number(1, 0), new Number(1, 13), width/16 + width/50, height/5 + height/50, width/3 - width/25, height/13, "Upgrade 1", font, color(255), knapFarve, knapHoverFarve, knapFarve);
